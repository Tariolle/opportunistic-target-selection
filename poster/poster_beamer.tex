...
\spacedbluebox{\textbf{Goal.} Pick a viable target from the trajectory, then commit early to avoid class drift.}
...
\sechead{5}{Mechanism}
\begin{center}
\includegraphics[height=21.4cm,keepaspectratio]{fig_theta.pdf}
\end{center}
...
\begin{center}
\includegraphics[height=22.0cm,keepaspectratio]{fig_headline_bars.pdf}
\end{center}
...
\begin{center}
\includegraphics[height=23.6cm,keepaspectratio,trim=0 45pt 436pt 24pt,clip]{fig_lockin.pdf}
\end{center}
